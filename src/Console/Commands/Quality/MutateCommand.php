...
#[AsCommand(
    ...
    aliases: ['mutate', 'infection', 'mutation'],
)]
        ...
        $this
            ...
            ->setHelp(
                ...
                <comment>Examples:</comment>
                  <info>hive mutate</info>                    Run with default settings
                  <info>hive mutate --min-msi=80</info>       Set minimum MSI threshold
                  <info>hive mutate --threads=8</info>        Use 8 threads
                  <info>hive mutate --show-mutations</info>   Show all mutations
