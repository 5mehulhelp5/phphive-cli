 ...
 * hive make:workspace my-project --type=monorepo
 *
 * # Skip git initialization
 * hive make:workspace my-project --no-git
 * ```
 *
 * After running this command:
 * 1. cd into the new workspace directory
 * 2. Run `pnpm install` to install dependencies
 * 3. Run `hive install` to install workspace dependencies
 * 4. Start developing!
 *
...
final class MakeWorkspaceCommand extends BaseCommand
{
        ...
        $this
            ...
            ->setHelp(
                ...
                <comment>Examples:</comment>
                  ...
                  <info>hive make:workspace --type=package</info>     Specific type
    ...
    private function createReadme(string $name, string $type): void
    {
        ...
        A {$type} workspace powered by PhpHive CLI and Turborepo.
        ...
        - `hive dev` - Start development server
        - `hive build` - Build for production
        - `hive test` - Run tests
        - `hive lint` - Check code style
        - `hive format` - Fix code style
        ...
        - [PhpHive CLI Documentation](https://github.com/phphive/cli)
