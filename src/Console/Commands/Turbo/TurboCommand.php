 ...
 * - Pattern matching: --filter=@phphive/*
        ...
        $this
            ...
            ->setHelp(
                ...
                <comment>Examples:</comment>
                  <info>hive turbo run build --filter=api</info>
                  <info>hive turbo run test --force</info>
                  <info>hive turbo prune --scope=api</info>
                  <info>hive turbo run lint --no-cache</info>
