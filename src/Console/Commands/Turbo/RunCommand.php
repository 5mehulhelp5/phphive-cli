...
namespace PhpHive\Cli\Console\Commands\Turbo;
        ...
        $this
            ...
            ->setHelp(
                ...
                <comment>Examples:</comment>
                  <info>hive run build</info>                Run build task in all workspaces
                  <info>hive run test --workspace=api</info> Run test in specific workspace
                  <info>hive run lint --force</info>         Force run lint task
                  <info>hive run custom --parallel</info>    Run custom task in parallel
