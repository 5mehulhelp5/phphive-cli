 ...
 * ./cli/bin/mono refactor
 *
 * # Preview changes without applying (safe)
 * ./cli/bin/mono refactor --dry-run
 *
 * # Clear cache and refactor
 * ./cli/bin/mono refactor --clear-cache
 *
 * # Preview with fresh cache
 * ./cli/bin/mono rector --clear-cache --dry-run
 * ```
 *
        ...
        $this
            ...
            ->setHelp(
                ...
                <comment>Examples:</comment>
                  <info>mono refactor</info>              Apply refactoring changes
                  <info>mono refactor --dry-run</info>    Preview changes without applying
                  <info>mono refactor --clear-cache</info> Clear cache and refactor
